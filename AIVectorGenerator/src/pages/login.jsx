        ...
        <Box sx={{width: '100%', height: '100vh', background: `url(${backgroundImg})`, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <Paper sx={{width: '35%', height: 400, backgroundColor: '#F5F5F5', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative'}}>
                ...
                <Box sx={{width: '70%', height: 135, display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                    <Button href="http://137.184.140.243/auth/google" sx={{width: '100%', backgroundColor: '#DB4437', color: 'white'}} variant="contained" startIcon={<GoogleIcon/>}>
                        Sign in using google
                    </Button>
                    <Button href="http://137.184.140.243/auth/facebook" sx={{width: '100%', backgroundColor: '#4267B2', color: 'white'}} variant="contained" startIcon={<FacebookIcon/>}>
                        Sign in using facebook
                    </Button>
                    <Button href="http://137.184.140.243/auth/linkedin" sx={{width: '100%', backgroundColor: '#0077B5', color: 'white'}} variant="contained" startIcon={<LinkedInIcon/>}>
